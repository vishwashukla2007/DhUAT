({
    ...
    handledelete : function(component, event, helper) {
        if (component.get("{!v.activerownum}") == 1)
        {
            var toastEvent = $A.get("e.force:showToast");
    		toastEvent.setParams({
        	"title": "Error!",
            "type": 'error',
             "message": "Last Rebate Guarantees record can't be Deleted."
    		});
   			 toastEvent.fire();
        }
        else
    ...
    handleChange : function(component, event, helper) {
        ...
        var inputcmp3 = component.find("inputPlan");
        var value = inputcmp3.get("v.value");
        component.set("{!v.objects.Plan_Design__c}",value);
        
        var inputcmp4 = component.find("inputGSTP");
        ...
        var inputcmp5 = component.find("inputSpec");
        ...
        var inputcmp6 = component.find("inputBrandBasis");
    ...
    handleSave:function(component, event, helper){
			...
			{
			   component.set("v.PicklistError",true);
			...
			if(Req5==1 && Req6==1 && Req7==1 && Req8==1 && Req9==1 && Req10==1 && Req11==1 && Req12==1 ){
				component.set("v.PercentageErrorMsg",true);
			...
			if(Req13==1 && Req14==1 && Req15==1 && Req16==1 && Req17==1 && Req18==1 && Req19==1 && Req20==1 )
            {
				...
				component.set("v.DollarErrormsg",true);
			...
			if(Req1 == 0 && Req2 == 0 && Req3 == 0 && Req4 == 0 && (Req5 == 0 || Req6 == 0 || Req7 == 0 || Req8== 0 || Req9 == 0 || Req10 == 0 || Req11 == 0 || Req12 == 0) && (Req13 == 0 || Req14 == 0 || Req15 == 0 || Req16 == 0 || Req17 == 0 || Req19 == 0 || Req20 == 0))
            {
				...
				var action = component.get("c.get_InsertRebatedata");
