({
    ...
    handleSave : function(component, event, helper) {
        ...
        var inputcmp5 = component.find("input5");
        var value = inputcmp5.get("v.value");
        if((value == null || value =="") && component.get("v.flatrequired")==true)
        {
        ...
        var inputcmp11 = component.find("input11");
        var value = inputcmp11.get("v.value");
        if((value == null || value =="") && component.get("v.nonmacrequired")==true)
        {
        ...
        if (Req1 == 1 || Req2 == 1 || Req3 == 1 || Req4 == 1 || Req5 == 1 || Req6 == 1 || Req7 == 1 || Req8 == 1 || Req9 == 1 || Req10 == 1 || Req11 == 1 || Req12 == 1 || Req13 == 1)
        {
        ...
        if(Req1 == 0 && Req2 == 0 && Req3 == 0 && Req4 == 0 && Req5 == 0 && Req6 == 0 && Req7 == 0 && Req8 == 0 && Req9 == 0 && Req10 == 0 && Req11 == 0 && Req12 == 0 && Req13 == 0)
        {
    ...
    handledelete : function(component, event, helper) {
        //alert('activerownum------'+component.get("{!v.activerownum}"));
