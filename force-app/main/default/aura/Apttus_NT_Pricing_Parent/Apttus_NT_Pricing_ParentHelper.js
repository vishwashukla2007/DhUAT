({
    ...
    getntPricinginfo : function(component, event) {
        var action = component.get("c.getNetworkpricing");
        action.setParams({ netopId : component.get("v.ntopId") });
        action.setCallback(this, function(result) {
            var state = result.getState();
            if (state === "SUCCESS") {
                component.set("v.ntpricings", result.getReturnValue());
            }
    ...
    deleteSelectedRecords : function(component, event, selctedRec) {
        ...
        action.setCallback(this, function(result) {
            ...
            if (state === "SUCCESS") {
                ...
                navEvt.setParams({
                    "recordId": component.get("v.ntopId"),
                    "slideDevName": "detail"
                });
                navEvt.fire();
            }
