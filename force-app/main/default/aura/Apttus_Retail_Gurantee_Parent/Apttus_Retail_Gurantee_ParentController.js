({
    ...
    doInit : function(component, event, helper) {
        helper.getntGurateeinfo(component, event);
                //helper.isDeleteAccess(component, event);

    },
    clickNew : function(component, event, helper) {
        var npLabel = $A.get("$Label.c.FAFIDNetworkGuarantee");
        var npId = component.get("v.ntpriceid");
        component.set("v.params", 'lightning=true&'+npLabel+'='+npId);
...
selectAllRecords : function(component, event, helper){
        ...
        var allRecords = component.get("v.retailgurantee");
