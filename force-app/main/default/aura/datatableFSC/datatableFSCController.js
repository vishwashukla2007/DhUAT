({
    init: function (cmp, event, helper) {
        ...
        if(cmp.get('v.mydata_standard2') && cmp.get('v.mydata_standard2').length > 0){
            ...
            cmp.set('v.filterdata', cmp.get('v.mydata_standard2'));
        ...
        */
        ...
        if(cmp.get('v.mydata_standard4') && cmp.get('v.mydata_standard4').length > 0){
            ...
            cmp.set('v.filterdata', cmp.get('v.mydata_standard4'));    
        ...
        */
        ...
        cmp.set('v.validate', function() {
            return { isValid: false, errorMessage: 'Please select record on the table' };
        })
    ...
    searchTable : function (cmp, event, helper) {
        var allRecords = cmp.get("v.filterdata");
