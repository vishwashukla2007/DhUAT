({
                ...
                {   
                    ...
                    action.setCallback(this, function(response) {
                        ...
                        if (state === "SUCCESS") 
                        {
                            ...
                            appEvent.setParams({ "Section" : "ELECTRONIC" });
                            appEvent.fire();
                            if (component.get("v.pricingcount") >= component.get("v.yearcount"))
                            {
                                component.set("v.disablebtn", true);
                        ...
                        else if (state === "ERROR")
                        {
                            ...
                            {
                                message = "Error in Updating Electronic Administration Fee Information";
                            }   
    ...
    create : function(component, event, helper) 
    {
        ...
        {
           admobj = component.get("v.newobject"); 
        }
