({    getAccessInfo : function(component, event) {
 ...
 component.set("v.isAccess", result.getReturnValue());
	...
	getmailPricinginfo : function(component, event) {
		 var action = component.get("c.getMailPricing");
         action.setParams({ mailOpId : component.get("v.mailOpId") });
         action.setCallback(this, function(result) 
         {
           ...
           if (state === "SUCCESS") 
           {
                component.set("v.mailPricingList", result.getReturnValue());
           }
  ...
  deleteSelectedRecords : function(component, event, selctedRec) {
      ...
      action.setCallback(this, function(result) {
          var state = result.getState();
           console.log('resultresultresultresultresult'+result.getError());
          console.log('resultresultresultresulstatetresult'+state);
          if (state === "SUCCESS") {
              ...
              navEvt.setParams({
                  "recordId": component.get("v.mailOpId"),
                  "slideDevName": "detail"
              });
              navEvt.fire();
          }
