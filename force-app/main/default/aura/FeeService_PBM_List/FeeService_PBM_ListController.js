({
    ...
    {    
        component.set( 'v.mycolumns', [                
            ...
            {label: 'Notes', fieldName: 'PBMURLNote', type: 'url',sortable: false,typeAttributes: {label: { fieldName: 'note' }, target: '_blank'}},
        ]);    
            ...
            var url = '/apex/NewPBMService?CF00N0x000003UeR6_lkid='+cmp.get("v.recordId")+'&redUrl='+ currentURL;
            ...
            var currentData = component.get("v.pbmList");
...
component.set("v.pbmList", newData);
